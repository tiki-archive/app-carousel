            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                      ...
                      child: Column(children: [
                        Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: service.infoCarouselService.style.size(4*3.75), vertical: service.infoCarouselService.style.size(3*8.12)),
                  ...
                  Container(
                      color: const Color(0xFFAFAFAF),
                      padding: EdgeInsets.only(left: service.infoCarouselService.style.size(4*3.75), top: service.infoCarouselService.style.size(3*8.12), right: service.infoCarouselService.style.size(4*3.75)),
                      child: Column(children: [
                        Container(
                            alignment: Alignment.centerLeft,
                            child: const InfoCarouselCardViewScrollCtaHeading()),
                        Container(
                            padding: EdgeInsets.only(top: service.infoCarouselService.style.size(2*8.12)),
                            child: const InfoCarouselCardViewScrollCtaExplain()),
                        Container(
                            padding: EdgeInsets.symmetric(vertical: service.infoCarouselService.style.size(5*8.12)),
